...
Create table employee(emp_no int(10),emp_name varchar(20)NOT NULL,DOB varchar(10),address varchar(20),DOJ varchar(10),mobile_no int (10) unique, dept_no int(10),salary int (10),designation varchar(20) NOT NULL,PRIMARY KEY(emp_no),FOREIGN KEY(dept_no) REFERENCES department(dept_no));
...
insert into employee values('129','AKHIL','16/02/1996','ATTINGAL','19/10/2019',12349567,1,8500,'AI ENGINNER');
...
update employee set salary=1000000 where designation='AI ENGINNER';
select * from employee;
update employee set mobile_no=123344432 where emp_name="LUCKY";
delete from employee where salary=750000;
...
#11 part
select department.dept_name,sum(employee.salary) as total_salary from department join employee on(department.dept_no=employee.dept_no) group by dept_name having sum(employee.salary)>15000;